...
int main(void)
{
	...
	xTaskCreate(vTask1_handler_menu_display, "TASK-1-menu_display", 500, NULL, 1, &xTaskHandle1);
	xTaskCreate(vTask2_handler_cmd_handling, "TASK-2-cmd_handling", 500, NULL, 1, &xTaskHandle2);
	xTaskCreate(vTask3_handler_cmd_processing, "TASK-3-cmd_processing", 500, NULL, 1, &xTaskHandle3);
	xTaskCreate(vTask4_handler_uart_write, "TASK-4-uart_writey", 500, NULL, 1, &xTaskHandle4);
